  ...
  return (
    <main className="page-wrap px-4 pb-8 pt-14">
      <section className="island-shell rounded-[2rem] px-6 py-10 sm:px-10 sm:py-14">
        ...
        <p className="mb-3 max-w-2xl text-base text-[var(--sea-ink-soft)] sm:text-lg">
          Reload the page or return home. If the issue persists, inspect the server or browser logs.
        </p>
        <pre className="overflow-x-auto rounded-2xl border border-[var(--line)] bg-black/5 p-4 text-sm text-[var(--sea-ink-soft)]">
          {error.message}
        </pre>
      </section>
    </main>
